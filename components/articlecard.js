    ...
    return (
        <div className="w-36 lg:w-64 xl:w-80 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-6 my-4">
            ...
            <div className="text-xs p-5">
                <a href="#">
                    <h5 className="text-sm mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{article.attributes.title}</h5>
                </a>
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{article.attributes.description}</p>
